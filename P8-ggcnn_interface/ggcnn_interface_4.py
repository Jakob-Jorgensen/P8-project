...
if MODEL_CHOSE == 'ggcnn': 
    MODEL_PATH = 'ckpt/ggcnn_epoch_23_cornell_statedict.pt' # The GGCNN is trained on the cornell dataset 
    NETWORK = GGCNN()

elif MODEL_CHOSE == 'ggcnn2':  
    MODEL_PATH = 'ckpt/epoch_0213_acc_0.6374.pth' # The GGCNN2 is trained on the jacquard dataset 
    NETWORK = GGCNN2()
else: 
