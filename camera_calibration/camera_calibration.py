...
class CameraCalibration:
    ...
    def __init__(self, image_folder, Transforms_folder, pattern_size=(17, 24), square_size=0.0075, ShowProjectError=False, ShowCorners=True):
        ...
        self.image_files = sorted(glob.glob(f'{image_folder}/*.jpg'))
...
if __name__== "__main__":
    ...
    image_folder = "RGBImgs/"
    PoseFolder = "T_base2ee/"
